...
5.	This plugin has already been registered in the "EOMFunc Plugins" Category in the
	...
	<Plugin DisplayName = "VB_NET Example1" ProgID = "AGI.EOMFunc.Plugin.Examples.Stk.VB_NET.Example1"/>
