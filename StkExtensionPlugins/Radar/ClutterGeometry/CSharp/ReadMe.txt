...
VGT Axes Plugin Samples written in C#.
...
6.	This plugin has already been registered in the "Radar Clutter Geometry Plugin" Category in the
	...
	<Plugin DisplayName = "Clutter Geometry CSharp Example" ProgID = "Agi.Radar.ClutterGeometry.CSharp.Example1"/>
