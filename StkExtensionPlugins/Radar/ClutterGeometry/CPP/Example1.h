...
class ATL_NO_VTABLE CExample1 : 
    ...
    public IDispatchImpl<IExample1, &IID_IExample1, &LIBID_AgiRadarClutterGeometryCPPExampleLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
    public IAgUtPluginConfig,
    public IAgStkRadarClutterGeometryPlugin
{
    public:
        struct CartVec
        {
        ...
        BEGIN_COM_MAP(CExample1)
            ...
            COM_INTERFACE_ENTRY(IAgStkRadarClutterGeometryPlugin)
        ...
        //===================================
        STDMETHOD(Register)(IAgStkRadarClutterGeometryPluginRegInfo* registrationInfo);
        STDMETHOD(Initialize)(IAgUtPluginSite* site);
        STDMETHOD(PreCompute)(VARIANT_BOOL* pValidPreCompute);
        STDMETHOD(Compute)(IAgStkRadarClutterGeometryComputeParams* computeParams);
        ...
        //==================================
        STDMETHOD(get_PatchArea)(double* pPatchArea);
        STDMETHOD(put_PatchArea)(double patchArea);
        STDMETHOD(get_OffsetAngle)(double* pOffsetAngle);
        STDMETHOD(put_OffsetAngle)(double offsetAngle);
    ...
    private:
        ...
        CComPtr<IAgStkRadarCBIntersectComputeParams> m_pCbIntersectComputeParams;
