...
def PY_Constraint_register():
    ...
    args.append(
        "ArgumentType = Input ; ArgumentName = fromPos ; Name = fromPosition ; RefName = Fixed "
    )

    args.append(
        "ArgumentType = Input ; ArgumentName = fromVel ; Name = fromVelocity ; RefName = Inertial "
    )

    args.append(
        "ArgumentType = Input ; ArgumentName = fromQuat ; Name = fromQuaternion; RefName = Fixed "
    )

    args.append(
        "ArgumentType = Input ; ArgumentName = fromObj ; Name = fromObjectPath "
    )

    args.append(
        "ArgumentType = Input ; ArgumentName = toPos ; Name = toPosition ; RefName = Fixed "
    )

    args.append(
        "ArgumentType = Input ; ArgumentName = toVel ; Name = toVelocity ; RefName = Inertial "
    )

    args.append(
        "ArgumentType = Input ; ArgumentName = toQuat ; Name = toQuaternion; RefName = Fixed "
    )
