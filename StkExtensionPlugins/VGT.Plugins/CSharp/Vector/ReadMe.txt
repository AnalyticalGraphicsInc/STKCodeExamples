...
VGT Vector Plugin Samples written in C#.
...
6.	This plugin has already been registered in the "VGT Vector Plugins" Category in the
	...
	<Plugin DisplayName = "CSharp Vector Example" ProgID = "Agi.VGT.Vector.Plugin.Examples.CSharp.Example1"/>
...
9.  Use STK documentation for directions on how to configure an VGT Vector Plugin for a 
    given STK Object.
