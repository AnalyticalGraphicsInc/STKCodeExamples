...
6.	This plugin has already been registered in the "VGT CalcScalar Plugins" Category in the
	...
	<Plugin DisplayName = "CSharp CalcScalar Example" ProgID = "Agi.VGT.CalcScalar.Plugin.Examples.CSharp.Example1"/>
...
9.  Use STK documentation for directions on how to configure an VGT CalcScalar Plugin for a 
    given STK Object.
