...
6.	This plugin has already been registered in the "VGT Axes Plugins" Category in the
	...
	<Plugin DisplayName = "VB_NET Axes Example" ProgID = "Agi.VGT.Axes.Plugin.Examples.VB_NET.Example1"/>
...
9.  Use STK documentation for directions on how to configure an VGT Axes Plugin for a 
    given STK Object.
