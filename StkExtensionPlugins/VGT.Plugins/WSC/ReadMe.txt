...
3.  This step registers your component as a COM component.
    ...
    'regsvr32 YOUR_FILENAME'. For example: regsvr32 VGT.Axes.VBScript.Example1.wsc  .

    Dll components not built using .NET

    Create a command window (under the Start menu, hit "Run ...", type 'Command' and hit OK).
    Change your directory (using cd) to that of the file. At the command prompt, type 
    'regsvr32 YOUR_FILENAME'. For example: regsvr32 Agi.VGT.Axes.Plugin.Examples.CPP.Example.dll .
    ...
    regasm /codebase Agi.VGT.Axes.Plugin.Examples.CSharp.dll  .
...
4.	This plugin has already been registered in the "VGT Vector Plugins" Category in the
	"VGT Vector Plugins.xml" plugin point registration file; however the registration lies
...
7.  Use STK documentation for directions on how to configure a VGT Vector Plugin
