...
Density Plugin Samples written in C#.
...
5.	This plugin has already been registered in the "Density Model Plugins" Category in the
	"DensityModel.xml" plugin point registration file; however the registration lies
	...
	<Plugin ProgID = "Density.Exponential.CSharp" DisplayName = "CSharp Exponential Density Example"/>
...
8.  Use STK documentation for directions on how to configure an Density Plugin for a 
    given satellite.
