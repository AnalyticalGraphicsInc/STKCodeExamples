...
HPOP Plugin Samples written in VB.NET.
...
5.	This plugin has already been registered in the "HPOP Plugins" Category in the
	...
	<Plugin DisplayName = "VB_NET SRP Example" ProgID = "AGI.Hpop.Plugin.Examples.Stk.ForceModeling.Srp.VB_NET.Example1"/>
...
8.  Use STK documentation for directions on how to configure an Hpop Plugin for a 
    given satellite.
