...
m_Name						= "VBScript.Example1.Hpop.wsc"
m_Enabled					= true
	...
	If( Not m_AgUtPluginSite is Nothing ) Then
		...
		If( m_Enabled = true ) Then
			...
			If( Not AgAsHpopPluginResult is Nothing ) Then
				...
				Dim WholeDays_Index
				Dim SecsIntoDay_Index
				Dim Year_Index
				Dim DayOfYear_Index
				Dim Month_Index	
                Dim DayOfMonth_Index	
				Dim Hours_Index
				Dim	Minutes_Index
				Dim Seconds_Index
				...
				vbArrayTimes = AgAsHpopPluginResult.RefEpochElements_Array( eUTC )
				...
				If( m_MsgStatus = true ) Then
					...
					Call m_AgUtPluginSite.Message( eLogMsgDebug, "PrePropagate():" )
					Call m_AgUtPluginSite.Message( eLogMsgDebug, "PrePropagate(): Epoch WholeDays( " & vbArrayTimes( WholeDays_Index ) & " )" )
					Call m_AgUtPluginSite.Message( eLogMsgDebug, "PrePropagate(): Epoch SecsIntoDay( " & vbArrayTimes( SecsIntoDay_Index ) & " )" )
					Call m_AgUtPluginSite.Message( eLogMsgDebug, "PrePropagate(): Epoch Year( " & vbArrayTimes( Year_Index ) & " )" )
					Call m_AgUtPluginSite.Message( eLogMsgDebug, "PrePropagate(): Epoch DayOfYear( " & vbArrayTimes( DayOfYear_Index ) & " )" )
					Call m_AgUtPluginSite.Message( eLogMsgDebug, "PrePropagate(): Epoch Month( " & vbArrayTimes( Month_Index ) & " )" )
                    Call m_AgUtPluginSite.Message( eLogMsgDebug, "PrePropagate(): Epoch DayOfMonth( " & vbArrayTimes( DayOfMonth_Index ) & " )" )
					Call m_AgUtPluginSite.Message( eLogMsgDebug, "PrePropagate(): Epoch Hours( " & vbArrayTimes( Hours_Index ) & " )" )
					Call m_AgUtPluginSite.Message( eLogMsgDebug, "PrePropagate(): Epoch Minutes( " & vbArrayTimes( Minutes_Index ) & " )" )
					Call m_AgUtPluginSite.Message( eLogMsgDebug, "PrePropagate(): Epoch Seconds( " & vbArrayTimes( Seconds_Index ) & " )" )
	...
	If(m_SrpIsOn) Then
		...
		If( Not m_CrdnConfiguredVector is Nothing) Then
			...
			If( Not ResultEval is Nothing ) Then
				...
				VecPosDotProd 	= ( VecArray( VecX_Index ) * PosVelArray( PosX_Index ) ) + ( VecArray( VecY_Index ) * PosVelArray( PosY_Index ) ) + ( VecArray( VecZ_Index ) * PosVelArray( PosZ_Index ) )
				VecMag			= Sqr( ( VecArray( VecX_Index ) )^2 + ( VecArray( VecY_Index ) )^2 + ( VecArray( VecZ_Index ) )^2 )
				PosMag			= Sqr( ( PosVelArray( PosX_Index ) )^2 + ( PosVelArray( PosY_Index ) )^2 + ( PosVelArray( PosZ_Index ) )^2 )
				Theta			= ACosine( VecPosDotProd / ( VecMag * PosMag ) )
