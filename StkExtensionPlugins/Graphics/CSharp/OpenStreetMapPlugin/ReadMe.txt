...
Open Street Map Plugin Sample written in C#.
...
6.	The plugin dll has to be registered using regasm which can be found at the following locations:
	...
	Open a command prompt in the appropriate directory and run the following command:
		regasm /codebase "<install dir>\<CodeSamples>\Extend\Graphics\CSharp\OpenStreetMapPlugin\bin\<Config>\OpenStreetMapPlugin.dll"
	
7.  Run the GraphicsHowTo sample and select the "Add custom imagery to the globe" code snippet
