...
Projection Raster Stream Plugin Sample written in C#.
...
6.	The plugin dll has to be registered using regasm which can be found at the following locations:
	...
	Open a command prompt in the appropriate directory and run the following command:
		regasm /codebase "<install dir>\<CodeSamples>\Extend\Graphics\CSharp\ProjectionRasterStreamPlugin\bin\<Config>\ProjectionRasterStreamPlugin.dll"
