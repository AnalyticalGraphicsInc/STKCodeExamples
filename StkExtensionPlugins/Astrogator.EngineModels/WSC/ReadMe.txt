...
3.  This step registers your component as a COM component.
    ...
    'regsvr32 YOUR_FILENAME'. For example: regsvr32 VBScript.Example1.EngineModel.WSC  .
    ...
    regasm /codebase AGI.Astrogator.Plugin.Examples.EngineModeling.CSharp.Example1  .
...
4.	This plugin has already been registered in the "Engine Models" Category in the
