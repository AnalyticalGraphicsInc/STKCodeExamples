...
ex. `addDirectionalArrows('Aircraft/testAircraft',10,20,45,3,true)`
...
ex. `[passiveCheck,minRangeP,badManeuverTimes] = astgCheckPassiveSafety(root, 'Satellite1', 'Satellite2', 1000, 10)`
...
For finite maneuvers the delta V vector is placed at the beginning of the maneuver and appears after the maneuver occurs. Change Line 193 to put the dV vector at the start of the burn: ephDP = sat.DataProviders.Item('Astrogator Maneuver Ephemeris Block Initial');
...
ex. `GrazingAngle('Satellite/Satellite1', -45)`
...
* Other Scripts: N/A
* Scenario: https://sdf.agi.com/share/page/site/agi-support/document-details?nodeRef=workspace://SpacesStore/fe8f63d5-77f1-40e7-975a-2319d78ae18a
