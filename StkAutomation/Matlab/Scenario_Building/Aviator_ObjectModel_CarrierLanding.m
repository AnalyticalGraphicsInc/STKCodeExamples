...
disp("...Adding Oceana Naval Air Station");

facilityKntu = scenario.Children.New(8, "OCEANA_NAS__APOLLO_SOUCEK_FIELD");  % 8 = AgESTKObjectType.eFacility
...
disp("...Adding CVN-72 carrier ship");
...
disp("...Creating lead hornet aircraft");

aircraftHornetLead = scenario.Children.New(1, "Hornet_Flight_Lead");  % 1 = AgESTKObjectType.eAircraft
...
aircraftHornetLead.Graphics.Attributes.Line.Width = 2;  % medium thickness. 2 = AgELineWidth.e3
...
disp("...Lead hornet - adding takeoff procedure");

% Add a takeoff procedure from a runway
takeoffHornetLead = proceduresHornetLead.Add(6, 22);  % 6 = AgEAvtrSiteType.eSiteRunway, 22 = AgEAvtrProcedureType.eProcTakeoff
...
disp("...Lead hornet - adding enroute procedure to approach ship")

enrouteHornetLead = proceduresHornetLead.Add(9, 8);  % 9 = AgEAvtrSiteType.eSiteSTKObjectWaypoint, 8 = AgEAvtrProcedureType.eProcEnroute
...
enrouteHornetLeadSite.OffsetMode = 3;  % 3 = AgEAvtrSTKObjectWaypointOffsetMode.eOffsetRelativeBearingRange
...
enrouteHornetLead.NavigationOptions.NavMode = 2;  % 2 = AgEAvtrPointToPointMode.eArriveOnCourse
enrouteHornetLead.NavigationOptions.ArriveOnCourse = 135;  % deg


% Add a 2nd Enroute Procedure to "Enter the Stack"

disp("...Lead hornet - adding enroute procedure to enter stack")

enroute2HornetLead = proceduresHornetLead.Add(9, 8);    % 9 = AgEAvtrSiteType.eSiteSTKObjectWaypoint, 8 = AgEAvtrProcedureType.eProcEnroute
...
% Set Offset mode and bearing/range values
enroute2HornetLeadSite.OffsetMode = 3; % 3 = AgEAvtrSTKObjectWaypointOffsetMode.eOffsetRelativeBearingRange
...
% Set the navigation options
enroute2HornetLead.NavigationOptions.NavMode = 1;  % 1 = AgEAvtrPointToPointMode.eArriveOnCourseForNext

% Set the enroute cruise airspeed options
enroute2HornetLead.EnrouteCruiseAirspeedOptions.CruiseSpeedType = 1; % 1 = AgEAvtrCruiseSpeed.eMaxEnduranceAirspeed
...
disp("...Lead hornet - adding maneuever to enter Case I Marshall");

% Add a Basic Maneuver procedure from the end of the previous procedure
basicManeuverHornetLead = procedures2HornetLead.Add(1, 5);  % 1 = AgEAvtrSiteType.eSiteEndOfPrevProcedure, 5 = AgEAvtrProcedureType.eProcBasicManeuver
...
stationkeepingNavHornetLead.StopCondition = 1;  % 1 = AgEAvtrStationkeepingStopCondition.eStopAfterTurnCount
...
% Set the altitude options
autoProfileHornetLead.AltitudeMode = 1;  % 1 = AgEAvtrAutopilotAltitudeMode.eAutopilotSpecifyAltitude
autoProfileHornetLead.AbsoluteAltitude = 2000;  % ft
autoProfileHornetLead.AltitudeControlMode = 0;  % 0 = AgEAvtrAutopilotAltitudeControlMode.eAutopilotAltitudeRate
...
autoProfileHornetLead.AirspeedOptions.AirspeedMode = 3;  % 3 = AgEAvtrBasicManeuverAirspeedMode.eMaintainMaxEnduranceAirspeed
autoProfileHornetLead.AirspeedOptions.MinSpeedLimits = 0;  % 0 = AgEAvtrBasicManeuverStrategyAirspeedPerfLimits.eConstrainIfViolated
autoProfileHornetLead.AirspeedOptions.MaxSpeedLimits = 0;  % 0 = AgEAvtrBasicManeuverStrategyAirspeedPerfLimits.eConstrainIfViolated

% Set the attitude/performance/fuel options
basicManeuverHornetLead.FlightMode = 3;  % 3 = AgEAvtrPhaseOfFlight.eFlightPhaseCruise
basicManeuverHornetLead.FuelFlowType = 1;  % 1 = AgEAvtrBasicManeuverFuelFlowType.eBasicManeuverFuelFlowCruise
...
basicManeuverHornetLead.AltitudeLimitMode = 0;  % 0 = AgEAvtrBasicManeuverAltitudeLimit.eBasicManeuverAltLimitError
basicManeuverHornetLead.TerrainImpactMode = 2;  % 2 = AgEAvtrBasicManeuverAltitudeLimit.eBasicManeuverAltLimitContinue


% Add a Basic Maneuver to "Enter Break"

disp("...Lead hornet - adding maneuever to enter break")

% Add a Basic Maneuver procedure from the end of the previous procedure
basicManeuver2HornetLead = procedures2HornetLead.Add(1, 5);  % 1 = AgEAvtrSiteType.eSiteEndOfPrevProcedure, 5 = AgEAvtrProcedureType.eProcBasicManeuver
...
% Set the altitude options
autoProfile2HornetLead.AltitudeMode = 1;  % 1 = AgEAvtrAutopilotAltitudeMode.eAutopilotSpecifyAltitude
autoProfile2HornetLead.AbsoluteAltitude = 800;  % ft
autoProfile2HornetLead.AltitudeControlMode = 0;  % 0 = AgEAvtrAutopilotAltitudeControlMode.eAutopilotAltitudeRate
...
% Set the airspeed options
autoProfile2HornetLead.AirspeedOptions.AirspeedMode = 1;  % 1 = AgEAvtrBasicManeuverAirspeedMode.eMaintainSpecifiedAirspeed
autoProfile2HornetLead.AirspeedOptions.SpecifiedAirspeedType = 2;  % 2 = AgEAvtrAirspeedType.eCAS
autoProfile2HornetLead.AirspeedOptions.SpecifiedAirspeed = 350;  % nm/hr
autoProfile2HornetLead.AirspeedOptions.MinSpeedLimits = 0;  % 0 = AgEAvtrBasicManeuverStrategyAirspeedPerfLimits.eConstrainIfViolated
autoProfile2HornetLead.AirspeedOptions.MaxSpeedLimits = 0;  % 0 = AgEAvtrBasicManeuverStrategyAirspeedPerfLimits.eConstrainIfViolated

% Set the attitude/performance/fuel options
basicManeuver2HornetLead.FlightMode = 3;  % 3 = AgEAvtrPhaseOfFlight.eFlightPhaseCruise
basicManeuver2HornetLead.FuelFlowType = 1;  % 1 = AgEAvtrBasicManeuverFuelFlowType.eBasicManeuverFuelFlowCruise
...
basicManeuver2HornetLead.AltitudeLimitMode = 0;  % 0 = AgEAvtrBasicManeuverAltitudeLimit.eBasicManeuverAltLimitError
basicManeuver2HornetLead.TerrainImpactMode = 2;  % 2 = AgEAvtrBasicManeuverAltitudeLimit.eBasicManeuverAltLimitContinue


% Add a Basic Maneuver Procedure to "Break"

disp("...Lead hornet - adding maneuever to break");

% Add a Basic Maneuver procedure from the end of the previous procedure
basicManeuver3HornetLead = procedures2HornetLead.Add(1, 5);  % 1 = AgEAvtrSiteType.eSiteEndOfPrevProcedure, 5 = AgEAvtrProcedureType.eProcBasicManeuver
...
% Set control limit
relCourse2.SetControlLimit(2, 29.9725);  % 2 = AgEAvtrBasicManeuverStrategyNavControlLimit.eNavMaxTurnRate, deg/s
...
autoProfile3HornetLead.AltitudeControlMode = 0;  % 0 = AgEAvtrAutopilotAltitudeControlMode.eAutopilotAltitudeRate
...
% Set the airspeed options
autoProfile3HornetLead.AirspeedOptions.AirspeedMode = 1;  % 1 = AgEAvtrBasicManeuverAirspeedMode.eMaintainSpecifiedAirspeed
autoProfile3HornetLead.AirspeedOptions.SpecifiedAirspeedType = 2;  % 2 = AgEAvtrAirspeedType.eCAS
autoProfile3HornetLead.AirspeedOptions.SpecifiedAirspeed = 145;  % nm/hr
autoProfile3HornetLead.AirspeedOptions.SpecifiedAccelDecelMode = 1;  % 1 = AgEAvtrPerfModelOverride.eOverride
autoProfile3HornetLead.AirspeedOptions.SpecifiedAccelDecelG = 0.3;  % G's
autoProfile3HornetLead.AirspeedOptions.MinSpeedLimits = 0;  % 0 = AgEAvtrBasicManeuverStrategyAirspeedPerfLimits.eConstrainIfViolated
autoProfile3HornetLead.AirspeedOptions.MaxSpeedLimits = 0;  % 0 = AgEAvtrBasicManeuverStrategyAirspeedPerfLimits.eConstrainIfViolated

% Set the attitude/performance/fuel options
basicManeuver3HornetLead.FlightMode = 3;  % 3 = AgEAvtrPhaseOfFlight.eFlightPhaseCruise
basicManeuver3HornetLead.FuelFlowType = 1;  % 1 = AgEAvtrBasicManeuverFuelFlowType.eBasicManeuverFuelFlowCruise
...
basicManeuver3HornetLead.AltitudeLimitMode = 0;  % 0 = AgEAvtrBasicManeuverAltitudeLimit.eBasicManeuverAltLimitError
basicManeuver3HornetLead.TerrainImpactMode = 2;  % 2 = AgEAvtrBasicManeuverAltitudeLimit.eBasicManeuverAltLimitContinue


% Add a Basic Maneuver Procedure to "Recover" (Land on Ship)

disp("...Lead hornet - adding maneuever to recover");

% Add a Basic Maneuver procedure from the end of the previous procedure
basicManeuver4HornetLead = procedures2HornetLead.Add(1, 5);  % 1 = AgEAvtrSiteType.eSiteEndOfPrevProcedure, 5 = AgEAvtrProcedureType.eProcBasicManeuver
...
relFpa.AirspeedOptions.AirspeedMode = 0;  % 0 = AgEAvtrBasicManeuverAirspeedMode.eMaintainCurrentAirspeed
relFpa.AirspeedOptions.MaintainAirspeedType = 3;  % 3 = AgEAvtrAirspeedType.eTAS
relFpa.AirspeedOptions.MinSpeedLimits = 0;  % 0 = AgEAvtrBasicManeuverStrategyAirspeedPerfLimits.eConstrainIfViolated
relFpa.AirspeedOptions.MaxSpeedLimits = 0;  % 0 = AgEAvtrBasicManeuverStrategyAirspeedPerfLimits.eConstrainIfViolated

% Set the attitude/performance/fuel options
basicManeuver4HornetLead.FlightMode = 3;  % 3 = AgEAvtrPhaseOfFlight.eFlightPhaseCruise
basicManeuver4HornetLead.FuelFlowType = 1;  % 1 = AgEAvtrBasicManeuverFuelFlowType.eBasicManeuverFuelFlowCruise
...
basicManeuver4HornetLead.AltitudeLimitMode = 0;  % 0 = AgEAvtrBasicManeuverAltitudeLimit.eBasicManeuverAltLimitError
basicManeuver4HornetLead.TerrainImpactMode = 2;  % 2 = AgEAvtrBasicManeuverAltitudeLimit.eBasicManeuverAltLimitContinue
...
disp("...Creating wingman hornet aircraft");

aircraftHornetWing = scenario.Children.New(1, "Hornet_Flight_Wing");  % 1 = AgESTKObjectType.eAircraft
...
disp("...Wing hornet - adding enroute procedure to approach Lead hornet");

enrouteHornetWing = proceduresHornetWing.Add(15, 8);  % 15 = AgEAvtrSiteType.eSiteWaypoint, 8 = AgEAvtrProcedureType.eProcEnroute
...
% Set the navigation options
enrouteHornetWing.NavigationOptions.NavMode = 2;  % 2 = AgEAvtrPointToPointMode.eArriveOnCourse
enrouteHornetWing.NavigationOptions.ArriveOnCourse = 340.691;  % deg


% Add a Basic Maneuver Procedure to "Intercept Leader"

disp("...Wing hornet - adding maneuver to intercept Lead hornet");

% Add a Basic Maneuver procedure from the end of the previous procedure
basicManeuverHornetWing = proceduresHornetWing.Add(1, 5);  % 1 = AgEAvtrSiteType.eSiteEndOfPrevProcedure, 5 = AgEAvtrProcedureType.eProcBasicManeuver
...
disp("...Wing hornet - adding maneuver to fly in formation to Marshall");
...
rendezvousForm.StopCondition = 2;  % 2 = AgEAvtrRendezvousStopCondition.eStopAfterTargetCurrentPhase
...
basicManeuverHornetWing.FuelFlowType = 1;  % 1 = AgEAvtrBasicManeuverFuelFlowType.eBasicManeuverFuelFlowCruise
...
basicManeuverHornetWing.AltitudeLimitMode = 0;  % 0 = AgEAvtrBasicManeuverAltitudeLimit.eBasicManeuverAltLimitError
basicManeuverHornetWing.TerrainImpactMode = 2;  % 2 = AgEAvtrBasicManeuverAltitudeLimit.eBasicManeuverAltLimitContinue


% Add a Basic Maneuver Procedure to "Split - Marshall - 3 Kft"

disp("...Wing hornet - adding maneuver to fly Marshall at 3 Kft split from Lead hornet");

% Add a Basic Maneuver procedure from the end of the previous procedure
basicManeuver2HornetWing = proceduresHornetWing.Add(1, 5);  % 1 = AgEAvtrSiteType.eSiteEndOfPrevProcedure, 5 = AgEAvtrProcedureType.eProcBasicManeuver
...
% Set stop condition options
stationkeepingNavHornetWing.StopCondition = 1;  % 1 = AgEAvtrStationkeepingStopCondition.eStopAfterTurnCount
...
% Set the altitude options
autoProfileHornetWing.AltitudeMode = 1;  % 1 = AgEAvtrAutopilotAltitudeMode.eAutopilotSpecifyAltitude
...
autoProfileHornetWing.AirspeedOptions.MinSpeedLimits = 0;  % 0 = AgEAvtrBasicManeuverStrategyAirspeedPerfLimits.eConstrainIfViolated
autoProfileHornetWing.AirspeedOptions.MaxSpeedLimits = 0;  % 0 = AgEAvtrBasicManeuverStrategyAirspeedPerfLimits.eConstrainIfViolated

% Set the attitude/performance/fuel options
basicManeuver2HornetWing.FlightMode = 3;  % 3 = AgEAvtrPhaseOfFlight.eFlightPhaseCruise
basicManeuver2HornetWing.FuelFlowType = 1;  % 1 = AgEAvtrBasicManeuverFuelFlowType.eBasicManeuverFuelFlowCruise
...
basicManeuver2HornetWing.AltitudeLimitMode = 0;  % 0 = AgEAvtrBasicManeuverAltitudeLimit.eBasicManeuverAltLimitError
basicManeuver2HornetWing.TerrainImpactMode = 2;  % 2 = AgEAvtrBasicManeuverAltitudeLimit.eBasicManeuverAltLimitContinue


% Add a Basic Maneuver Procedure to "Marshall - Step Down - 2 Kft"

disp("...Wing hornet - adding maneuver to fly Marshall stepped down to 2 Kft");

% Add a Basic Maneuver procedure from the end of the previous procedure
basicManeuver3HornetWing = proceduresHornetWing.Add(1, 5);  % 1 = AgEAvtrSiteType.eSiteEndOfPrevProcedure, 5 = AgEAvtrProcedureType.eProcBasicManeuver
...
% Set stop condition options
stationkeeping2NavHornetWing.StopCondition = 1;  % 1 = AgEAvtrStationkeepingStopCondition.eStopAfterTurnCount
...
autoProfile2HornetWing.AltitudeControlMode = 0;  % 0 = AgEAvtrAutopilotAltitudeControlMode.eAutopilotAltitudeRate
...
% Set the airspeed options
autoProfile2HornetWing.AirspeedOptions.AirspeedMode = 3;  % 3 = AgEAvtrBasicManeuverAirspeedMode.eMaintainMaxEnduranceAirspeed
autoProfile2HornetWing.AirspeedOptions.MinSpeedLimits = 0;  % 0 = AgEAvtrBasicManeuverStrategyAirspeedPerfLimits.eConstrainIfViolated
autoProfile2HornetWing.AirspeedOptions.MaxSpeedLimits = 0;  % 0 = AgEAvtrBasicManeuverStrategyAirspeedPerfLimits.eConstrainIfViolated

% Set the attitude/performance/fuel options
basicManeuver3HornetWing.FlightMode = 3;  % 3 = AgEAvtrPhaseOfFlight.eFlightPhaseCruise
basicManeuver3HornetWing.FuelFlowType = 1;  % 1 = AgEAvtrBasicManeuverFuelFlowType.eBasicManeuverFuelFlowCruise
...
basicManeuver3HornetWing.AltitudeLimitMode = 0;  % 0 = AgEAvtrBasicManeuverAltitudeLimit.eBasicManeuverAltLimitError
basicManeuver3HornetWing.TerrainImpactMode = 2;  % 2 = AgEAvtrBasicManeuverAltitudeLimit.eBasicManeuverAltLimitContinue
