...
propSeg1 = mcs.Item('Propagate');

% Create a new descneding node stopping condition
...
propSeg2.StoppingConditions.Add('Apoapsis');
...
dV2 = tgtSeq2.Segments.Insert('eVASegmentTypeManeuver', 'dV2', '-');

% Set the attitude type to full thrust vector
dV2.Maneuver.SetAttitudeControlType('eVAAttitudeControlThrustVector');
...
% Assign values to maneuver
dV2Att.AssignCartesian(dV1x, dV1y, dV1z);
...
dV2.EnableControlParameter('eVAControlManeuverImpulsiveCartesianY');
dV2.EnableControlParameter('eVAControlManeuverImpulsiveCartesianZ');
