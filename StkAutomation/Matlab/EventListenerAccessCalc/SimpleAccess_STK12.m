...
%like me - it has two...get the second, its nicer
root = uiapp.Personality2;
%attach the m-file RootEvents as an event listener on the root object
root.registerevent('RootEvents')

%create new scenario
scenario = root.Children.New('eScenario','STK_MATLAB_Integration');
scenario.SetTimePeriod('24 Oct 2017 12:00:00.000','25 Oct 2017 12:00:00.000');
scenario.StartTime = '24 Oct 2017 12:00:00.000';
scenario.StopTime = '25 Oct 2017 12:00:00.000';
...
%propagate sat...
root.ExecuteCommand(['SetState */Satellite/Sat Cartesian J4Perturbation "', scenario.StartTime,'" "', scenario.StopTime ,'" 60 ICRF "',scenario.StartTime,'" -5465000.513055 4630000.194365 0.0 712.713627 841.292034 7377.687805']);
