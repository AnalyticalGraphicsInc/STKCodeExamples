...
namesAndPlaces = [bvfList, bvfWList, lenaList, lenaIList, lenaWList, beacList, hqList, patList]
...
def initializeStk(StkEngine: bool = False, scenarioName: str = "PythonApi", scenarioPath: str = "") -> Union[Tuple[STKEngineApplication, AgStkObjectRoot],Tuple[STKDesktopApplication, AgStkObjectRoot]]:
...
runways.MasterDataFilepath = "C:\\Program Files\\AGI\\STK 12\\Data\\Resources\\stktraining\\samples\\FAANFD18"
...
telRgnlAlt = float(telRgnlVals[6].replace("Altitude: ", ""))/3.28084  # Convert FT to meters

# Create Telluride Regional as a Place Object - not included in namesAndPlaces due to special origin
telRgnl = AgPlace(scenario.Children.New(AgESTKObjectType.ePlace, 'TellurideRegionalAirport'))
...
beaconXmtr = AgTransmitter((namesAndObjects[5])[1].Children.New(AgESTKObjectType.eTransmitter, "BeaconXmtr"))
...
terfol = AgAvtrAircraftTerrainFollowModel(cessna.TerrainFollow.GetAsCatalogItem().AddDefaultChild("Cessna 206"))
...
takeoff = AgAvtrProcedureTakeoff(takeoffProcs.Add(AgEAvtrSiteType.eSiteRunwayFromCatalog, AgEAvtrProcedureType.eProcTakeoff))
...
terfolToTel = AgAvtrProcedureTerrainFollow(takeoffProcs.Add(AgEAvtrSiteType.eSiteSTKStaticObject, AgEAvtrProcedureType.eProcTerrainFollowing))
...
terfolToBVFWay = AgAvtrProcedureTerrainFollow(toBVF.Procedures.Add(AgEAvtrSiteType.eSiteSTKStaticObject, AgEAvtrProcedureType.eProcTerrainFollowing))
...
terfolToBVFView = AgAvtrProcedureTerrainFollow(toBVF.Procedures.Add(AgEAvtrSiteType.eSiteSTKStaticObject, AgEAvtrProcedureType.eProcTerrainFollowing))
...
bvfHolding = AgAvtrProcedureHoldingRacetrack(toBVF.Procedures.Add(AgEAvtrSiteType.eSiteEndOfPrevProcedure, AgEAvtrProcedureType.eProcHoldingRacetrack))
...
bvfHolding.HoldCruiseAirspeedOptions.CruiseSpeedType = AgEAvtrCruiseSpeed.eMaxRangeAirspeed
turnDirCmd = f'MissionModeler */Aircraft/{aircraftObjectName} Procedure 5 SetValue Direction 1'
...
terfolToBVFWayExit = AgAvtrProcedureTerrainFollow(toLena.Procedures.Add(AgEAvtrSiteType.eSiteSTKStaticObject, AgEAvtrProcedureType.eProcTerrainFollowing))
...
terfolToLenaInlet = AgAvtrProcedureTerrainFollow(toLena.Procedures.Add(AgEAvtrSiteType.eSiteSTKStaticObject, AgEAvtrProcedureType.eProcTerrainFollowing))
...
terfolToLenaWay = AgAvtrProcedureTerrainFollow(toLena.Procedures.Add(AgEAvtrSiteType.eSiteSTKStaticObject, AgEAvtrProcedureType.eProcTerrainFollowing))
...
terfolToLenaBasin = AgAvtrProcedureTerrainFollow(toLena.Procedures.Add(AgEAvtrSiteType.eSiteSTKStaticObject, AgEAvtrProcedureType.eProcTerrainFollowing))
...
basinHolding = AgAvtrProcedureHoldingRacetrack(toLena.Procedures.Add(AgEAvtrSiteType.eSiteEndOfPrevProcedure, AgEAvtrProcedureType.eProcHoldingRacetrack))
...
basinHolding.HoldCruiseAirspeedOptions.CruiseSpeedType = AgEAvtrCruiseSpeed.eMaxRangeAirspeed
turnDirCmd = f'MissionModeler */Aircraft/{aircraftObjectName} Procedure 10 SetValue Direction 0'
stkRoot.ExecuteCommand(turnDirCmd)
...
terfolToLenaWayExit = AgAvtrProcedureTerrainFollow(toTelRgnl.Procedures.Add(AgEAvtrSiteType.eSiteSTKStaticObject, AgEAvtrProcedureType.eProcTerrainFollowing))
...
terfolToLenaInletExit = AgAvtrProcedureTerrainFollow(toTelRgnl.Procedures.Add(AgEAvtrSiteType.eSiteSTKStaticObject, AgEAvtrProcedureType.eProcTerrainFollowing))
...
terfolToTelExit = AgAvtrProcedureTerrainFollow(toTelRgnl.Procedures.Add(AgEAvtrSiteType.eSiteSTKStaticObject, AgEAvtrProcedureType.eProcTerrainFollowing))
...
landing = AgAvtrProcedureLanding(toTelRgnl.Procedures.Add(AgEAvtrSiteType.eSiteRunwayFromCatalog, AgEAvtrProcedureType.eProcLanding))
...
landing.EnrouteCruiseAirspeedOptions.CruiseSpeedType = AgEAvtrCruiseSpeed.eMaxRangeAirspeed
...
rcvrAntennaAC = AgAntennaModelGaussian(complexEmergencyRcvr.AntennaControl.EmbeddedModel)
rcvrAntennaAC.DesignFrequency = rcvrDesFreqAC
rcvrAntennaAC.Diameter = rcvrAntennaDiamAC

# Add Aircraft Transmitter
emergencyXmtr = AgTransmitter(ac.Children.New(AgESTKObjectType.eTransmitter, 'EmergencyXmtr'))

# Add Ski Patrol HQ Walkie
hqWalkie = AgTransmitter(namesAndObjects[6][1].Children.New(AgESTKObjectType.eTransmitter, 'WalkieHQ'))
...
xmtrAntennaWalkie = AgAntennaModelPencilBeam(complexXmtrWalkie.AntennaControl.EmbeddedModel)
xmtrAntennaWalkie.DesignFrequency = hqWalkieDesFreq

# Add Ski Patroller Walkie
patrolWalkie = AgReceiver(namesAndObjects[7][1].Children.New(AgESTKObjectType.eReceiver, 'WalkiePatrol'))
...
rcvrAntennaWalkie = AgAntennaModelPencilBeam(complexRcvrWalkie.AntennaControl.EmbeddedModel)
...
AgPlace(namesAndObjects[6][1]).AccessConstraints.AddConstraint(AgEAccessConstraints.eCstrAzElMask)

# Add Az-El Mask to Ski Patroller
AgPlace(namesAndObjects[7][1]).SetAzElMask(AgEAzElMaskType.eTerrainData, 0)
AgPlace(namesAndObjects[7][1]).AccessConstraints.AddConstraint(AgEAccessConstraints.eCstrAzElMask)
