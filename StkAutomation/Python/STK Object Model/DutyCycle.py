...
# Prioritize Target?
prioritize = True
primaryTargetName = 'AreaTarget3'

# Duty Cycle Allotted Time (min)
dutyCycleTime = 10 
...
dutyCycleTime = dutyCycleTime*60

# Get Satellite object
sat = AgSatellite(scenario.Children.Item(satName))
...
if prioritize:
    primaryIndex = ATNames.index(primaryTargetName)
...
# For each orbit, create availability intervals for the sensor
# Check first for Area Target within 
