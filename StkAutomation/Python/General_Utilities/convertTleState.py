...
for i in range(sats.Count):
    ...
    if sat.PropagatorType == 4: # SGP4
        ...
        newSat = scenario.Children.New(18, sat.InstanceName+'_New') # eSatellite
        ...
        newSat.Propagator.InitialState.Representation.AssignCartesian(11, x[0], y[0], z[0], vx[0], vy[0], vz[0])    # ICRF
