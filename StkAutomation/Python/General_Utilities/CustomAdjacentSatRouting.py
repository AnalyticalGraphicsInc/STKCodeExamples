...
def createRoutingFile(
    ...
    Args:
        ...
        satellites.
        shells (int): Shell ID number used in a satellite collection. If a constellation
        object is used, ignore this value.
                    ...
                    for k in range(satsPerPl[i]):
                        for m in range(planeReach + 1):
                            for n in range(satReach + 1):
                                ...
                                sat2_sat = sat1_sat + n
                                sat3_sat = sat1_sat - n
                                sat2_plane, sat2_sat, sat3_sat, xtra0 = constructSyntax(
                                    sat1_plane,
                                    sat1_sat,
                                    sat2_plane,
                                    sat2_sat,
                ...
                for j in range(planes[i]):
                    for k in range(satsPerPl[i]):
                        ...
                        line = (
                            ...
                            + "/Receiver/"
                            + commInfo[1]
                            + str((sat1_plane - 1) * satsPerPl[i] + sat1_sat)
                            + " Satellite/"
                            + name
                            + xtra0[0]
                            + str(sat1_plane)
...
if __name__ == "__main__":
    filePath = r"C:\Users\username\Documents\Python\sample.routing"  # Ex: "C:\\Users\\username\\Documents\\adjacent.routing"
    ...
    commInfo = [
        "Tx",
        "Rx",
        "Place/Finish/Receiver/Receiver2",
        "Place/Start/Transmitter/Transmitter2",
