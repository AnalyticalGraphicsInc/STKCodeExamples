...
try:
    ...
    if checkempty == 0:
        ...
        inputText = input('Close the current scenario? Press enter to continue. If you have not saved, your progress will be lost.')
        if inputText == "":
...
# Set control limits
relBearing.SetControlLimit(0,0); # 0 = AgEAvtrBasicManeuverStrategyNavControlLimit.eNavUseAccelPerfModel
...
cruiseProfileHornetWing.ReferenceFrame = 0; # 0 = AgEAvtrBasicManeuverRefFrame.eEarthFrame

# Set the altitude options
cruiseProfileHornetWing.RequestedAltitude = 18000; # ft

# Set cruise airspeed
cruiseProfileHornetWing.CruiseAirspeedOptions.CruiseSpeedType = 2; # 2 = AgEAvtrCruiseSpeed.eMaxRangeAirspeed
