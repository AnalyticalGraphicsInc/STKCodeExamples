...
namespace Agi.UiPlugin.MoveMtoTime
{
    public partial class CustomConfigPage : UserControl, IAgUiPluginConfigurationPageActions2
    {
        ...
        #region Members
            ...
            {
                _site = Site;
                _plugin = _site.Plugin as MoveMtoTime;
            ...
            public void OnHelp()
            {
                IAgUiPluginSite2 site2 = (_site.Plugin as MoveMtoTime).Site as IAgUiPluginSite2;
                site2.ShowHelp( @"C:\Program Files\AGI\STK 10\Help\stk.chm", "", AgEUiPluginHelpDisplayType.eUiPluginHelpTOC);
            }
            #endregion
    }
}
