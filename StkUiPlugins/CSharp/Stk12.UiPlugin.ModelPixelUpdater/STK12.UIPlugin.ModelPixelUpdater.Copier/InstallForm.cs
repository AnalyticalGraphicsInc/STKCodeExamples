...
namespace STK12.UIPlugin.ModelPixelUpdater.Copier
{
    public partial class InstallForm : Form
    {
        ...
        {
            string displayName = STK12.UIPlugin.ModelPixelUpdater.Copier.Properties.Settings.Default.DisplayName;
            string typeName = STK12.UIPlugin.ModelPixelUpdater.Copier.Properties.Settings.Default.TypeName;
            string assemblyName = STK12.UIPlugin.ModelPixelUpdater.Copier.Properties.Settings.Default.AssemblyName;
