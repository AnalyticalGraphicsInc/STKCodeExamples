...
namespace CameraControlAutomator
{
    ...
    [Guid("e28b9c5c-9ce4-44ed-b797-eba197a50137")]
    [ProgId("CameraControlAutomator")]
    ...
    public class Setup : IAgUiPlugin, IAgUiPlugin2, IAgUiPlugin3DNotify, IAgUiPluginCommandTarget
    {
        ...
        private const string m_commandText = "CameraControlAutomator";
        private const string m_pluginTitle = "Camera Control Automator";
        private const string m_pluginDescription = "";
        private const string m_pluginConfigPage = "CameraControlAutomator Config Page";
        private const string m_imageResource = "CameraControlAutomator.Images.STK.ico";
        private const string m_configPath = "CameraControlAutomator_config.txt";
