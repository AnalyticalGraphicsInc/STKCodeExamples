...
using Agi.Ui.GreatArc.Stk11.Properties;

namespace Agi.Ui.GreatArc.Stk11
{
    [Guid("d4796865-8bd8-426b-8d06-9fddf3c013f3")]
    [ProgId("Agi.Ui.GreatArc.Stk11")]
    [ClassInterface(ClassInterfaceType.None)]
    public class GreatArc_11 : IAgUiPlugin, IAgUiPluginCommandTarget, IAgUiPlugin2
    {
            ...
            IAgUiPluginMenuBuilder2 MenuBuilder)
        {
            if (MenuTitle.Contains("Insert"))
            {
                ...
                picture1 = (stdole.IPictureDisp)Microsoft.VisualBasic.Compatibility.VB6.Support.ImageToIPicture(Agi.Ui.GreatArc.Stk11.Properties.Resources.acRoute64);
