...
namespace STK12.UIPlugin.Copier.TetkExample
{
    public partial class InstallForm : Form
    {
        ...
        {
            string displayName = STK12.UIPlugin.Copier.TetkExample.Properties.Settings.Default.DisplayName;
            string typeName = STK12.UIPlugin.Copier.TetkExample.Properties.Settings.Default.TypeName;
            string assemblyName = STK12.UIPlugin.Copier.TetkExample.Properties.Settings.Default.AssemblyName;
