...
namespace LoadExternalCoverageData
{
    public partial class CustomConfigPage : UserControl, IAgUiPluginConfigurationPageActions2
    {
        ...
        #region Members
            ...
            LoadExternalCoverageDataPlugin _plugin;
            ...
            {
                _site = Site;
                _plugin = _site.Plugin as LoadExternalCoverageDataPlugin;
            ...
            public void OnHelp()
            {
                IAgUiPluginSite2 site2 = (_site.Plugin as LoadExternalCoverageDataPlugin).Site as IAgUiPluginSite2;
                site2.ShowHelp( @"C:\Program Files\AGI\STK 12\Help\stk.chm", "", AgEUiPluginHelpDisplayType.eUiPluginHelpTOC);
            }
            #endregion
    }
}
