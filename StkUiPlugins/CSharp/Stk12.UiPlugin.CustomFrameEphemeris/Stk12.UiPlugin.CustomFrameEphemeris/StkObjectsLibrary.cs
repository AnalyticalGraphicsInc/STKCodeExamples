...
namespace Stk12.UiPlugin.CustomFrameEphemeris
{
    ...
    [Serializable]
    public class coordinateSystemError : Exception
    {

        const string message = "Coordinate System Is Invalid.";

        public coordinateSystemError() :
                base(message)
        { }
    ...
    [Serializable]
    public class filePathError : Exception
    {
        const string message = "File Path is Invalid.";
