...
namespace STK12.UIPlugin.CustomFrameEphemerisCopier
{
    public partial class InstallForm : Form
    {
        ...
        {
            string displayName = STK12.UIPlugin.CustomFrameEphemerisCopier.Properties.Settings.Default.DisplayName;
            string typeName = STK12.UIPlugin.CustomFrameEphemerisCopier.Properties.Settings.Default.TypeName;
            string assemblyName = STK12.UIPlugin.CustomFrameEphemerisCopier.Properties.Settings.Default.AssemblyName;
