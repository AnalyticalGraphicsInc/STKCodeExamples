...
namespace $safeprojectname$
{
    ...
    public class Setup : IAgUiPlugin, IAgUiPlugin2, IAgUiPlugin3DNotify, IAgUiPluginCommandTarget
    {
        ...
        private const string m_commandText = "$safeprojectname$";
        //private const string m_commandTextLocation = "$safeprojectname$.Location";
        //private const string m_commandTextGlobe = "$safeprojectname$.Globe";
        //private const string m_commandTextObject = "$safeprojectname$.Object";
        //private const string m_commandTextScreen = "$safeprojectname$.Screen";
        //private const string m_commandTextNone = "$safeprojectname$.None";
        private const string m_pluginTitle = "PluginTITLE";
        private const string m_pluginDescription = "PlugingDESCRIPTION";
        private const string m_pluginConfigPage = "$safeprojectname$ Config Page";
        private const string m_imageResource = "$safeprojectname$.Images.Target.png";
        private const string m_configPath = "stkplugtest_config.txt";
