...
### Build the Image
1. Run `docker build -t ansys/stk/stk-engine-webservice:12.4.0-centos7 .` on the command line in this directory.
...
`docker run -d -p 5000:5000 --env-file ../configuration/licensing.env --name stk-engine-webservice --rm ansys/stk/stk-engine-webservice:12.4.0-centos7`
