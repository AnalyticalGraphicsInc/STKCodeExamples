...
1. Run `docker build -t ansys/stk/stk-engine-connect:{version}-ubi8 .` on the command line in this directory after replacing `{version}` with the version number. i.e `12.7.1`
