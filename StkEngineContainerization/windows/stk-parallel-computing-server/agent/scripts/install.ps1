...
$coordinatorInstall = Get-ChildItem -Recurse -Path C:/TEMP/ -Filter 'STK Parallel Computing Agent*.msi'
...
Stop-Service "STK Parallel Computing Agent"
Set-Service "STK Parallel Computing Agent" -StartupType Disabled
