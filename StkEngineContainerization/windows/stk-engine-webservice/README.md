...
### Build the Image
1. Run `docker build -t ansys/stk/stk-engine-webservice:{version}-windowsservercore-ltsc2019 .` on the command line in this directory after replacing `{version}` with the version number. i.e `12.6.0`
