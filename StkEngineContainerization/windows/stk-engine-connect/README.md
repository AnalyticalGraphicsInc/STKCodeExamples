...
### Build the Image
1. Run `docker build -t ansys/stk/stk-engine-connect:12.4.0-windowsservercore-ltsc2019 .` on the command line in this directory.
...
`docker run -d -p 5001:5001 --env-file ../configuration/licensing.env --name stk-connect --rm ansys/stk/stk-engine-connect:12.4.0-windowsservercore-ltsc2019`
